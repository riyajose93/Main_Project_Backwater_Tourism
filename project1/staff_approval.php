        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="#"> <i class="menu-icon fa fa-dashboard"></i>DASHBORD</a>
                    </li>
                    <h3 class="menu-title">UI elements</h3><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Pending</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="../staff_approval.php">staff</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="ui-badges.html">Owner</a></li>
...
if(mysqli_num_rows($data)>0)
{
	...
	while($r=mysqli_fetch_array($data))
	{
		...
		<td><a href="app_rjt.php?id1=<?php echo $r['staff_regid'];?>"> verify</a></td>
		</tr>
		<?php
	}
	?>
